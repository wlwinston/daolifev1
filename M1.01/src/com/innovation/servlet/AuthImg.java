package com.innovation.servlet;
...
public class AuthImg extends HttpServlet
{
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        String englishBase = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
        //汉字长度
        int length = base.length();
        int enligsLength = englishBase.length();
        //字体
        ...
        for (int i=0;i<4;i++)
        {
	        int start = random.nextInt(enligsLength);
	        String rand=englishBase.substring(start,start+1);
	        sRand+=rand;
	
	        //赋值颜色
	        g.setColor(getRandColor(10,150));
	        //赋值字体
	        g.setFont(new Font("Verdana",Font.PLAIN,18 + random.nextInt(6)));
	        //写字
