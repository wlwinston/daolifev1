			...
			<table width="650" height="1022" border="0" cellpadding="0"
				...
				<tr>
					<td height="1021" valign="top">
						<!--左边区域-->
						<div class="zuo">
							<table width="495" height="45" border="0" align="center"
								...
								<tr>
									...
									<td width="125" align="left" valign="middle">
										<a href="daolife.html"><img src="images/chanpin_05.gif"
												width="123" height="31" />
										</a>
									</td>
									<td width="123" align="left" valign="middle">
										<a href="http://www.taobao.com"><img
												src="images/chanpin_07.gif" width="123" height="31" />
										</a>
									</td>
								</tr>
							</table>
							<table width="541" height="536" border="0" cellpadding="0"
								cellspacing="0" class="tabledao">
								<tr>
									<td height="63" align="center">
										<img src="images/chanpin_13.gif" width="426" height="421" />
									</td>
								</tr>
							</table>
							<table width="573" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="478" height="182" align="center" valign="top"
										class="ziti">
										...
										<table width="535" border="0" align="center" cellpadding="0"
											cellspacing="0">
											<tr>
												<td width="76" height="44" align="left">
													&nbsp;
												</td>
												<td width="459" align="left">
													<table width="420" height="21" border="0" cellpadding="0"
														cellspacing="0">
														<tr>
											...
											<tr>
												...
												<td align="left">
													<span class="text1">MTV跟我们一起玩儿了，当然，他们掏钱了，所以最后我们会送你们免费的T恤。<br />
														参与方式是在你的对话框里输入“＃MTV＃＋你为可口可乐设计的广告语”，别忘了提交，我们私下提醒你，越无聊越好。<br />
														活动时间为 2010年1月10日－2010年1月17日<br /> 活动结束，等着你的快递。</span>
												</td>
											</tr>
											<tr>
												<td height="50" align="left">
						...
						<div class="reight">
							...
							<table width="71%" height="177" border="0" align="center"
							...
							<table width="310" height="20" border="0" cellpadding="0"
								cellspacing="0" class="touxiang1">
								<tr>
