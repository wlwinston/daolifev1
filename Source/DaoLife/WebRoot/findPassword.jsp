			...
			<table width="539" border="0" align="center" cellpadding="4" cellspacing="4" class="zhuti3" style="height:463px;font-size:15px;">
				<tr>
					<td width="523" height="197" align="left" valign="top">
						<form action="FindPassword.action" method="post" name="regist"
							id="regist">
							<table width="623" border="0" cellspacing="3" cellpadding="0">
								...
								<tr>
									...
									<td>
										<label>
											<input type="text" size="5" style="width: 70px;" height="26"
												id="yzm" />
											<img src="servlet/dao.auth" id="picyzm"
												style="border: 0; width: 100px; margin: 0; float: left botton;" />
											&nbsp;
											<a href="javascript:reflashpic()">换一张</a>
								...
								<tr>
									...
									<td>
										<input type="image" src="images/password1.gif" />
									</td>
								</tr>
							</table>
						</form>
